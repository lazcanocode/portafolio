...
const Hero = () => {
  return (
    <div className='Hero'>
      <h1 className='Hero__text'>Hola soy Luis Alberto,desarrollador de software especilista backend</h1>
      <div className='Hero__img'>
        <img className='Hero__img--profile' src={profile} alt='Foto de Perfil' />
        <a target='_blank' href={githubLink}><img className='Hero__img--github' src={github} alt='Github' /></a>
        <a target='_blank' href={linkedinLink}><img className='Hero__img--linkedin' src={linkedin} alt='Github' /></a>
      </div>
    </div>
  );
};
